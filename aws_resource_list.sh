...
# 15. EBS
#
# This script is prompt user to enter region and service for which the resources need to list
#
...
# Check if AWS CLI was installed
...
if [ ! -d ~/.aws ]; then
	echo "AWS CLI is not configured please configured it and try again"
	exit 1
fi
